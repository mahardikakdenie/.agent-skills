...
export interface SwitchProps extends SwitchRootProps, VariantProps<typeof switchTrackVariants> {
  ...
  ({ className, thumbClassName, variant, size, ...props }, ref) => {
    return (
      <SwitchPrimitive.Root
        ...
        {...props}
      >
        <SwitchPrimitive.Thumb className={clsx(switchThumbVariants({ size }), thumbClassName)} />
      </SwitchPrimitive.Root>
    );
  },
);
