...
| Tabs            | 4             | B4            | DONE   | Shipped on 2026-03-10 with spec, Storybook, Radix compound exports, scrollable list support, and Box-authored tab triggers and panels; briefly realigned on 2026-04-03 to the navigation-surface variant work, then narrowed the shared contract back to `outline                                                                                                                                                                                                                                                                                                                                         | ghost`because the elevated`shadow` treatment was not carrying its weight |
