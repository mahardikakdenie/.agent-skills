...
| Tabs            | 4             | B4            | DONE   | Shipped on 2026-03-10 with spec, Storybook, Radix compound exports, scrollable list support, and Box-authored tab triggers and panels; realigned on 2026-04-03 to the shared navigation-surface variant family so the root now defaults to `outline` and individual triggers can still override locally |
