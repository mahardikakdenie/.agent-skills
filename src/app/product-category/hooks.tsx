...
export const useProducts = () => {
  ...
  const fetchProducts = async (params: any) => {
    const response: any = await productService.get(ApiURL.v1Products, { params });
    setProducts(response?.data?.data);
  };
  const fetchInsurances = async (params: any) => {
    const response: any = await productService.get(ApiURL.v1Insurances, { params });
  ...
  const updatePlan = async (data: any, id: string) => {
    const response: any = await productService.put(ApiURL.v1PlanDetails(id), data);
    return response?.data;
  };
  ...
  const uploadPackage = async (category: string, id: string, data: any) => {
    const response: any = await productService.post(ApiURL.packagesCategoryBulkCreateDetail(category, id), data);
    return response?.data;
  };

  const uploadPlanBenefits = async (id: string, data: any) => {
    const response: any = await productService.post(ApiURL.v1PlanBenefitBulkCreateDetails(id), data);
    return response?.data;
  };

  const uploadPlanDetails = async (id: string, type: string, data: any) => {
    const response: any = await productService.post(ApiURL.v1PlanBulkCreateDetailsType(id, type), data);
    return response?.data;
  };
  const flattenTree = (
    node: any,
  ...
  const getPlanBenefits = async (id: string) => {
    const response: any = await productService.get(ApiURL.v1PlanDetailsBenefits(id));
  ...
  const getPlanDetails = async (id: string, type: string) => {
    const response: any = await productService.get(ApiURL.v1PlanDetailsDetailsType(id, type));
  ...
  const assignPlans = async (planId: string, channel: string) => {
    ...
    const response: any = await productService.post(ApiURL.v1ChannelPackagesAssignPlans, { channel: extractChannel[0], plans: [planId], channelName: extractChannel[1] });
    await getChannelPlans(planId);
    return response?.data;
  };

  const unAssignPlans = async (planId: string, channelId: string) => {
    const response: any = await productService.post(ApiURL.v1ChannelPackagesUnassignPlans, { channel: channelId, plans: [planId] });
    await getChannelPlans(planId);
    return response?.data;
  };
  ...
  const getChannels = async () => {
    const response: any = await channelService.get(ApiURL.v1Channels, { params: { page: 1, limit: 100 } });
  ...
  const getChannelPlans = async (planId: string) => {
    const response: any = await productService.get(ApiURL.v1PlanDetailsChannels(planId));
  ...
  const updatePackage = async (id: string, data: any) => {
    const response: any = await productService.put(ApiURL.v1PackagesDetails(id), data);
    return response?.data;
  }

  const fetchProductConfigByType = async(type: string) => {
    const response: any = await productService.get(ApiURL.productConfigType(type));
    setProductConfig(response?.data)
  }

  const fetchPackageById = async (id: string) => {
    const response: any = await productService.get(ApiURL.v1PackagesDetails(id));
    setPackageDetail(response?.data);
  }

  const deletePackage = async (id: string) => {
    const response: any = await productService.delete(ApiURL.v1PackagesDetails(id));
    return response?.data;
  }

  const saveBenefit = async (data: any) => {
    const response: any = await productService.post(ApiURL.v1PlanBenefitCreate, data);
    return response?.data;
  }

  const deleteBenefit = async (id: string) => {
    const response: any = await productService.delete(ApiURL.v1PlanBenefitDetails(id));
    return response?.data;
  }
