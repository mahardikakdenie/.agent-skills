...
// import {FinanceBillingView} from "@/views/finance/billing/list/list.view";
//
...
import { useBilling } from "../../finance/billing/hook";
...
export default function BillingPage() {
    ...
    const getChannels = async () => {
        try {
            ...
            const channelResponse = await channelService.get(ApiURL.v1Channels, { params });
    ...
    const getCategories = async () => {
        try {
            setLoading(true);
            const categoriesResponse = await productService.get(ApiURL.v1Categories);
                                    ...
                                    <div className="relative group">
                                        <Button
                                            ...
                                            onClick={() => {
                                                ...
                                                router.push(`${AppURL.financeBillingDetail}/${billing.id}`);
                                            }
                                            }
                                        >
                      ...
                      View Detail
                                    ...
                                    <div className="relative group">
                                        <Button
                                            ...
                                            onClick={() => {
                                                localStorage.setItem("billingDetail", JSON.stringify({ "id": billing.id, "channel": searchChannel, "category": categories }));
                                                router.push(`${AppURL.financeBillingDetail}/${billing.id}/invoice?type=${searchType}`);
                                            }
                                            }
                                        >
