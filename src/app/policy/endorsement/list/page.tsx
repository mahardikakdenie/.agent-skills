...
// import { EndorsementListView } from "@/views/policy/endorsement/list/list.view";
//
// export default function EndorsementListPage() {
//     return <EndorsementListView />;
// }
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const res: any = await policyService.get(ApiURL.v1Endorsement, { params });
                setFilteredEndorsement(res.data?.data);
    ...
    return (
        <div className="flex flex-col w-full p-4 md:p-6 ">
            <div className="flex gap-4 pb-4 items-center">
                ...
                <Button onClick={() => router.push(AppURL.endorsementUpload)} className="bg-[#F5BA41] text-black hover:bg-[#e6a92d] ml-auto rounded-full">
                    <Upload className="w-5 h-5 mr-1 " /> Upload
                </Button>
                <Button onClick={() => router.push(AppURL.endorsementExport)} className="bg-[#F5BA41] text-black hover:bg-[#e6a92d] rounded-full">
