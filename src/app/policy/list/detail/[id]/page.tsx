...
// import {PolicyDetailView} from "@/views/policy/detail/detail.view";
//
...
export default function DetailPolicy() {
    ...
    useEffect(() => {
        const checkAccess = async () => {
            const isHidePolicyEmail = permissionList.includes("Policy.View.Policy.HideEmail");
            const isHidePolicyPhone = permissionList.includes("Policy.View.Policy.HidePhone");
            setPolicyVisibility({
                name: true,
    ...
    const handleRenewPolicy = async () => {
        setSubmit(true);
        try {
            await policyService.put(ApiURL.v1PolicyDetailsRenew(policy.id), {});
                ...
                <div>
                    <Breadcrumb className="sm:block hidden">
                        <BreadcrumbList>
                            ...
                            <BreadcrumbSeparator />
                            <BreadcrumbItem>
                                <BreadcrumbLink href={AppURL.policyList}>List</BreadcrumbLink>
                            </BreadcrumbItem>
                            <BreadcrumbSeparator />
                            <BreadcrumbItem>
