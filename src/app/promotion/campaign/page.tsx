...
export default function PromotionPage() {
  ...
  useEffect(() => {
    if (hasAccess) {
      ...
      promotionService
        .get(ApiURL.v1CampaignSearchQuery, { params })
        .then((res: any) => {
      ...
      const fetchNames = async () => {
        const channelFetches = promotionData.embedded_discount_channels.map(
          async (channel: { channel_id: string }) => {
            const res: any = channelService.get(
  ...
  const handleDelete = (id: string) => {
    if (window.confirm("Are you sure you want to delete this campaign?")) {
      promotionService
        .delete(ApiURL.v1CampaignDeleteDetails(id))
        .then(() => {
          setPromotions(
    ...
    <div className="container mx-auto p-6">
      ...
      <div className="bg-white rounded-md p-4 sm:p-6">
        ...
        <Table>
          <TableHeader>
            <TableRow>
              <TableHead className="align-middle">Campaign Name</TableHead>
                    ...
                    <div className="flex space-x-2">
                      <Drawer direction="right">
                        <DrawerTrigger
                          ...
                          onClick={() =>
                            handleViewDetail(promotion.campaign_id)
                          }
                        >
                          View
                        </DrawerTrigger>
                          ...
                          <div className="flex flex-col w-full h-full p-4 md:p-6 bg-[#F8F8F8] mt-5 rounded-xl overflow-y-auto">
                            <div className="rounded-lg flex flex-col gap-4 text-black">
                              ...
                              <div className="flex gap-2 text-sm font-medium">
                                ...
                                <div>
                                  {selectedPromotion
                                    ?.embedded_discount_insurances.length >
                                  0 ? (
