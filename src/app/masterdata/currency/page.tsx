...
const Currency = () => {
  ...
  const categoriesService = new CurrenciesService();
  ...
  return (
    <div className="flex flex-col w-full p-4 md:p-6">
      <div className="flex gap-2">
        <h1 className="text-black font-bold text-2xl mt-2 mb-4">Currency</h1>
        <Button
...
const CurrencyWithSidebar = (params: any) => WithSidebar(Currency)(params);
export default CurrencyWithSidebar;
