...
const AddPartner = () => {
  ...
  const onSubmit = async (data: PartnerFormData) => {
    ...
    try {
      ...
      if (response.data) {
        // Redirect to edit page with the new partner's ID
        router.push(`/masterdata/partner-management/${response.data.id}/edit`);
      }
    } catch (error: any) {
...
const AddPartnerWithSidebar = (params: any) => WithSidebar(AddPartner)(params);
export default AddPartnerWithSidebar;
