...
const EditEmailTag = ({ params }: { params: { id: string } }) => {
  useRequireAuth();
...
const EdiPEmailTagWithSidebar = (params: any) =>
  WithSidebar(EditEmailTag)(params);
export default EdiPEmailTagWithSidebar;
