...
export default function SourcePage() {
    ...
    useEffect(() => {
        sanctionService
            .get(ApiURL.v1SourcesPaging, { params: { page, limit: rowsPerPage } })
            .then((response: any) => {
    ...
    const handleViewDetail = async (id: string) => {
        try {
            const response: any = await sanctionService.get(ApiURL.v1SourcesDetails(id));
            const sanctionData = response.data.data[0];
    ...
    const handleSearch = async () => {
        ...
        sanctionService
            .get(ApiURL.v1SourcesPaging, { params: { keyword: searchTerm, page, limit: rowsPerPage } })
            .then((response: any) => {
                const res = response.data;
