...
// import {ListTransactionView} from "@/views/transaction/list/list-transaction.view";
// import {TransactionListAdminView} from "@/views/transaction/list/list-admin.view";
// import {useAuth} from "@/context/auth.context";
//
// export default function TransactionListPage() {
//     const {user} = useAuth();
//     return user?.role?.toLowerCase() === 'admin' ? (<TransactionListAdminView />) : (<ListTransactionView />);
// }
...
export default function TransactionsPage() {
    ...
    useEffect(() => {
        const params = {
            ...
            status: tab && tab === "All" ? undefined : tab
        };
        transactionService
            .get(ApiURL.v1Transactions, { params })
            .then((response: any) => {
        ...
        <div className="flex flex-col w-full p-4 md:p-6 ">
            <div className="flex pb-4 items-center justify-between">
                ...
                <div className="flex gap-4">
                    ...
                    <Button
                        onClick={() => router.push(AppURL.transactionImport)}
