...
// import { DashboardPolicy } from "@/views/dashboard/policy/policy.view";
//
...
import {policyService, productService} from "@/services/api.service";
...
export default function DashboardPolicy() {
  const [ policiesStatisticData, setPoliciesStatisticData ] = useState<any>(null);
  ...
  useEffect(() => {
    const fetchDataPolicy = async () => {
      try {
        ...
        const response: any = await policyService.get(ApiURL.v1PoliciesStatisticData, { params });
