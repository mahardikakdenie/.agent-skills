...
export default function SanctionPage() {
    ...
    useEffect(() => {
        sanctionService.get(ApiURL.v1Blacklist, { params: { page, limit: rowsPerPage } })
            .then((response: any) => {
    ...
    const handleViewDetail = async (id: string) => {
        try {
            const res: any = await sanctionService.get(ApiURL.v1BlacklistDetails(id));
    ...
    const handleSearch = async () => {
        ...
        sanctionService
            .get(ApiURL.v1Blacklist, { params: { keyword: searchTerm, page, limit: rowsPerPage } })
            .then((response: any) => {
                const res = response.data;
                setFilteredSanction(res.data); // Initialize with all sanctions
                setTotalItems(res.total);
