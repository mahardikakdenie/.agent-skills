...
export const LayoutView = ({
  ...
  const renderPasswordRequirements = () => {
    ...
    return (
      <>
        <div className="text-xs font-medium mt-0.5 mb-2">
                  ...
                  <div className="w-52 absolute top-full right-0 mt-2 bg-white shadow-lg rounded-md py-5 px-7">
                    <div className="flex flex-col items-center justify-center">
                      ...
                      <Button
                        variant="danger"
                        onClick={doLogout}
                        additionalClassName="w-full mt-3"
                      >
                        Logout
                      </Button>
                    </div>
      ...
      {isModalChangePassword && (
        ...
        >
          <div className="flex justify-center items-center mb-3 bg-white rounded-t-md">
            <div className="pt-5 pb-3 px-2 text-xl font-bold">
              Change Password
            </div>
          </div>
          <div className="h-fit max-h-[calc(70vh-50px)] overflow-y-auto sm:scrollable mb-5">
            ...
            <div className="w-full">
              ...
              <div className="mb-5">
                <Input
                  ...
                  value={newPassword}
                  onChange={(value) =>
                    handleChangeNewPassword(value.toString())
                  }
            ...
            <div className="text-sm mb-5">
              Once your password has been changed, please log back in with the
            ...
            {AppMenu.menu.map(
              (menuMobile, menuMobileIndex) =>
                menuList.includes(menuMobile.name) && (
                  <div
                    key={menuMobileIndex}
                    className={`${menuMobileIndex !== 0 && "mt-5"}`}
                  >
        ...
        >
          <div className="h-full flex flex-col">
            <div className="flex justify-center items-center">
              <div
                className={`${
                  !!process.env.NEXT_PUBLIC_LOGO && "py-5 px-2 mb-3"
                }`}
              >
                {/*TODO: change for customization in env*/}
                {process.env.NEXT_PUBLIC_MODE === "whitelable" ? (
