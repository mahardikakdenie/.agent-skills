...
export default function DetailTable({ data, columns }: DetailTableProps) {
  ...
  return (
    <div className="h-full relative">
      <button
        className="bg-primary text-white flex text-xs font-semibold mb-2 px-3 py-2 rounded-full hover:bg-sky-900 absolute bottom-full right-0"
      ...
      <div className="flex justify-between items-center mt-4">
        <div className="inline-flex ml-auto items-center">
          ...
          <button
            className="disabled:opacity-40 p-0"
