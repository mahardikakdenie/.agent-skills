class ApiURL {
  ...
  static cookieDetails = (key: string) => {
    return `${ApiURL.cookie}/${key}`;
  };
  ...
  static v1ChangePassword = (id: string) => {
    return `${ApiURL.v1Account}/${id}/change-password`;
  };

  static policies = "/policies";
  static v1Policies = `/v1${ApiURL.policies}`;
  static policyDetails = (id: string) => {
    return `${ApiURL.policies}/${id}`;
  };
  static v1PolicyDetails = (id: string) => {
    return `${ApiURL.v1Policies}/${id}`;
  };
  static v1PolicyDetailsRenew = (id: string) => {
    return `${ApiURL.v1PolicyDetails(id)}/renew`;
  };
  ...
  static v1PoliciesMasterDetail = (channel_id: string) => {
    return `${ApiURL.v1Policies}/master/${channel_id}`;
  };
  ...
  static claimDetails = (id: string) => {
    return `${ApiURL.claims}/${id}`;
  };
  static v1ClaimDetails = (id: string) => {
    return `${ApiURL.v1Claims}/${id}`;
  };
  static claimUpdateStatus = (id: string) => {
    return `${ApiURL.claims}/update-status/${id}`;
  };
  static v1ClaimUpdateStatus = (id: string) => {
    return `${ApiURL.v1Claims}/update-status/${id}`;
  };
  ...
  static claimCategoryFormsAll = (id: string) => {
    return `${ApiURL.claimCategoryForms}/all/${id}`;
  };
  static claimChannelFormsAll = (id: string) => {
    return `${ApiURL.claimChannelForms}/all/${id}`;
  };
  ...
  static v1ClaimChannelFormsAll = (id: string) => {
    return `${ApiURL.v1ClaimChannelForms}/all/${id}`;
  };
  static v1ClaimCategoryFormsAll = (id: string) => {
    return `${ApiURL.v1ClaimCategoryForms}/all/${id}`;
  };
  ...
  static transactionUpdateStatus = (id: string) => {
    return `${ApiURL.transactions}/payment/${id}`;
  };
  static v1TransactionDetails = (id: string) => {
    return `${ApiURL.v1Transactions}/${id}`;
  };
  static v1TransactionUpdateStatus = (id: string) => {
    return `${ApiURL.v1Transactions}/payment/${id}`;
  };
  static v1TransactionBulkCreateDetails = (id: string) => {
    return `${ApiURL.v1Transactions}/bulk-create/${id}`;
  };
  ...
  static v1CategoriesChannelDetails = (id: string) => {
    return `${ApiURL.v1CategoriesChannel}/${id}`;
  };

  static channels = "/channels";
  static v1Channels = `/v1${ApiURL.channels}`;
  static v1ChannelDetails = (id: string) => {
    return `${ApiURL.v1Channels}/${id}`;
  };

  static packages = "/packages";
  static v1Packages = `/v1${ApiURL.packages}`;
  static v1PackagesDetails = (id: string) => {
    return `${ApiURL.v1Packages}/${id}`;
  };
  static packagesCategory = (category: string) => {
    return `${ApiURL.packages}/${category}`;
  };
  static packagesCategoryBulkCreate = (category: string) => {
    return `${ApiURL.packagesCategory(category)}/bulk-create`;
  };
  static packagesCategoryBulkCreateDetail = (category: string, id: string) => {
    return `${ApiURL.packagesCategoryBulkCreate(category)}/${id}`;
  };
  ...
  static insuranceDetails = (id: string) => {
    return `${ApiURL.insurances}/${id}`;
  };
  static v1InsuranceDetails = (id: string) => {
    return `${ApiURL.v1Insurances}/${id}`;
  };
  static v1InsuranceDetailsCurrency = (id: string) => {
    return `${ApiURL.v1InsuranceDetails(id)}/currencies`;
  };
  static v1InsuranceDetailsCurrencyDetails = (
    insuranceId: string,
    currencyId: string
  ) => {
    return `${ApiURL.v1InsuranceDetailsCurrency(insuranceId)}/${currencyId}`;
  };

  static products = "/products";
  static v1Products = `/v1${ApiURL.products}`;
  static productDetails = (id: string) => {
    return `${ApiURL.products}/${id}`;
  };
  static v1ProductDetails = (id: string) => {
    return `${ApiURL.v1Products}/${id}`;
  };

  static productConfig = "/product-config";
  static productConfigType = (type: string) => {
    return `${ApiURL.productConfig}/${type}`;
  };
  ...
  static planDetails = (id: string) => {
    return `${ApiURL.plans}/${id}`;
  };
  static v1PlanDetails = (id: string) => {
    return `${ApiURL.v1Plans}/${id}`;
  };
  static v1PlanDetailsBenefits = (id: string) => {
    return `${ApiURL.v1PlanDetails(id)}/benefits`;
  };
  static v1PlanDetailsChannels = (id: string) => {
    return `${ApiURL.v1PlanDetails(id)}/channels`;
  };
  static v1PlanDetailsDetails = (id: string) => {
    return `${ApiURL.v1PlanDetails(id)}/details`;
  };
  static v1PlanDetailsDetailsType = (id: string, type: string) => {
    return `${ApiURL.v1PlanDetailsDetails(id)}/${type}`;
  };
  static v1PlanBulkCreate = `${ApiURL.v1Plans}/bulk-create`;
  static v1PlanBulkCreateDetails = (id: string) => {
    return `${ApiURL.v1PlanBulkCreate}/${id}`;
  };
  static v1PlanBulkCreateDetailsType = (id: string, type: string) => {
    return `${ApiURL.v1PlanBulkCreateDetails(id)}/${type}`;
  };
  static v1PlanBenefitBulkCreate = `${ApiURL.v1PlanBenefit}/bulk-create`;
  static v1PlanBenefitCreate = `${ApiURL.v1PlanBenefit}/create`;
  static v1PlanBenefitDetails = (id: string) => {
    return `${ApiURL.v1PlanBenefit}/${id}`;
  };
  static v1PlanBenefitBulkCreateDetails = (id: string) => {
    return `${ApiURL.v1PlanBenefitBulkCreate}/${id}`;
  };
  ...
  static billingDetails = (id: string) => {
    return `${ApiURL.billings}/${id}`;
  };
  static v1BillingDetails = (id: string) => {
    return `${ApiURL.v1Billings}/${id}`;
  };
  static v1BillingDetailsConfirmReconciliation = (id: string) => {
    return `${ApiURL.v1BillingDetails(id)}/confirm-reconcilliation`;
  };
  ...
  static v1InsuredPartiesDetails = (id: string) => {
    return `${ApiURL.v1InsuredParties}/${id}`;
  };
  static v1InsuredPartiesChannelDetails = (id: string) => {
    return `${ApiURL.v1InsuredPartiesChannel}/${id}`;
  };
  static masterPolicy = (id: string) => {
    return `/policies/master/${id}`;
  };
  ...
  static v1EndorsementDetail = (id: string) => {
    return `${ApiURL.v1Endorsement}/${id}`;
  };
  static v1EndorsementUpdateStatus = (id: string) => {
    return `${ApiURL.v1Endorsement}/update-status/${id}`;
  };
  static v1EndorsementUpdtaeStatusBulking = (id: string) => {
    return `${ApiURL.v1Endorsement}/update-status-bulking/${id}`;
  };
  static updateEndorsementStatus = (id: string) => {
    return `${ApiURL.endorsement}/update-status-bulking/${id}`;
  };

  static campaign = "/campaign";
  static v1Campaign = `/v1${ApiURL.campaign}`;
  static v1CampaignDetail = (id: string) => {
    return `${ApiURL.v1Campaign}/${id}`;
  };
  static v1CampaignReport = `${ApiURL.v1Campaign}/report`;
  static v1CampaignDelete = `${ApiURL.v1Campaign}/delete`;
  static v1CampaignDeleteDetails = (id: string) => {
    return `${ApiURL.v1CampaignDelete}/${id}`;
  };
  ...
  static v1CampaignEmbeddedHistoryDetails = (id: string) => {
    return `${ApiURL.v1CampaignEmbeddedHistory}/${id}`;
  };
  static v1CampaignUpdate = `${ApiURL.v1Campaign}/update`;
  static v1CampaignUpdateDetails = (id: string) => {
    return `${ApiURL.v1CampaignUpdate}/${id}`;
  };

  static fees = "/fees";
  static v1Fees = `/v1${ApiURL.fees}`;
  static v1FeesBroker = `${ApiURL.v1Fees}/broker`;
  static v1FeesBrokerDetail = (id: string) => {
    return `${ApiURL.v1Fees}/broker/${id}`;
  };
  static v1FeesBrokerFilter = `${ApiURL.v1Fees}/broker-filter`;
  static v1FeesChannel = `${ApiURL.v1Fees}/channel`;
  static v1FeesChannelDetail = (id: string) => {
    return `${ApiURL.v1Fees}/channel/${id}`;
  };
  ...
  static v1VoucherDetails = (id: string) => {
    return `${ApiURL.v1Voucher}/${id}`;
  };
  static v1VoucherCode = (code: string) => {
    return `/v1${ApiURL.voucher}/code/${code}`;
  };
  ...
  static v1BlacklistDetails = (id: string) => {
    return `${ApiURL.v1Blacklist}/${id}`;
  };
  static v1BlacklistUpdateDetails = (id: string) => {
    return `${ApiURL.v1BlacklistUpdate}/${id}`;
  };
  static v1BlacklistDeleteDetails = (id: string) => {
    return `${ApiURL.v1BlacklistDelete}/${id}`;
  };
  ...
  static v1SourcesDetails = (id: string) => {
    return `${ApiURL.v1Sources}/${id}`;
  };
  static v1SourcesUpdateDetails = (id: string) => {
    return `${ApiURL.v1SourcesUpdate}/${id}`;
  };
  static v1SourcesDeleteDetails = (id: string) => {
    return `${ApiURL.v1SourcesDelete}/${id}`;
  };
