...
export const BILLING_DETAIL = (id: string | number) =>
  `${BILLING}/detail/${id}`;
export const BILLING_DETAIL_INVOICE_WITH_TYPE = (
  id: string | number,
  type: string
) => `${BILLING_DETAIL(id)}/invoice?type=${type}`;
export const BILLING_DETAIL_EXPORT_WITH_TYPE = (
  id: string | number,
  type: string
) => `${BILLING_DETAIL(id)}/export?type=${type}`;
export const BILLING_DETAIL_IMPORT_WITH_TYPE = (
  id: string | number,
  type: string
) => `${BILLING_DETAIL(id)}/import?type=${type}`;

// Broker
export const BROKER = `${PROTECTED}/broker`;
export const BROKER_FEE = `${BROKER}/broker-fee`;
export const BROKER_FEE_ADD = `${BROKER_FEE}/add`;
export const BROKER_FEE_DETAIL = (id: string | number) =>
  `${BROKER_FEE}/edit/${id}`;
export const BROKER_PARTNER_COM = `${BROKER}/partner-com`;
export const BROKER_PARTNER_COM_ADD = `${BROKER_PARTNER_COM}/add`;
export const BROKER_PARTNER_DETAIL = (id: string | number) =>
  `${BROKER_PARTNER_COM}/edit/${id}`;
...
export const CLAIM_LIST_UPLOAD_DATA = (id: string | number) =>
  `${CLAIM_LIST}/${id}/upload-data`;

// Endorsement
export const ENDORSEMENT = `${PROTECTED}/endorsement`;
export const ENDORSEMENT_DETAIL = (id: string | number) =>
  `${ENDORSEMENT}/${id}`;
export const ENDORSEMENT_UPLOAD = `${ENDORSEMENT}/upload`;
export const ENDORSEMENT_EXPORT = `${ENDORSEMENT}/export`;
export const ENDORSEMENT_UPLOAD_WITH_ID = (id: string | number) =>
  `${ENDORSEMENT_DETAIL(id)}/upload`;
...
export const CURRENCY_DETAIL_WITH_INSURANCE_ID = (id: string | number) =>
  `${CURRENCY}/edit?insurance-id=${id}`;
...
export const EMAIL_TEMPLATE_DETAIL = (id: string | number) =>
  `${EMAIL_TEMPLATE}/${id}`;
...
export const EMAIL_TEMPLATE_TAG_DETAIL = (id: string | number) =>
  `${EMAIL_TEMPLATE_TAG}/edit/${id}`;
...
export const PAGE_MANAGEMENT_DETAIL = (id: string | number) =>
  `${PAGE_MANAGEMENT}/${id}`;
...
export const PARTNER_MANAGEMENT_DETAIL = (id: string | number) =>
  `${PARTNER_MANAGEMENT}/${id}/edit`;
...
export const MEMBERSHIP_LIST_DETAIL = (id: string | number) =>
  `${MEMBERSHIP_LIST}/${id}`;

// Policy List
export const POLICY_LIST = `${PROTECTED}/policy-list`;
export const POLICY_LIST_DETAIL = (id: string | number) =>
  `${POLICY_LIST}/${id}`;
...
export const PRODUCT_CATALOG_CATEGORY = (category: string | number) =>
  `${PRODUCT_CATALOG}/${category}`;
export const PRODUCT_CATALOG_DETAIL = (
  category: string | number,
  id: string | number
) => `${PRODUCT_CATALOG_CATEGORY(category)}/${id}`;
export const PRODUCT_CATALOG_ADD = (category: string | number) =>
  `${PRODUCT_CATALOG_CATEGORY(category)}/add`;
export const PRODUCT_CATALOG_UPLOAD = (
  category: string | number,
  id: string | number
) => `${PRODUCT_CATALOG_DETAIL(category, id)}/upload`;
export const PRODUCT_CATALOG_UPLOAD_BENEFIT = (
  category: string | number,
  id: string | number
) => `${PRODUCT_CATALOG_DETAIL(category, id)}/upload-benefit`;
export const PRODUCT_CATALOG_UPLOAD_DETAIL = (
  category: string | number,
  id: string | number
) => `${PRODUCT_CATALOG_DETAIL(category, id)}/upload-detail`;
export const PRODUCT_CATALOG_ADD_PACKAGE = (
  category: string | number,
  id: string | number
) => `${PRODUCT_CATALOG_DETAIL(category, id)}/add-package`;
export const PRODUCT_CATALOG_EDIT_PACKAGE = (
  category: string | number,
  productId: string | number,
  packageId: string | number
) => `${PRODUCT_CATALOG_DETAIL(category, productId)}/edit-package/${packageId}`;
export const PRODUCT_CATALOG_ADD_BENEFIT = (
  category: string | number,
  id: string | number
) => `${PRODUCT_CATALOG_DETAIL(category, id)}/add-benefit`;
export const PRODUCT_CATALOG_EDIT_BENEFIT = (
  category: string | number,
  productId: string | number,
  packageId: string | number
) => `${PRODUCT_CATALOG_DETAIL(category, productId)}/edit-benefit/${packageId}`;

// Promotion
export const PROMOTION = `${PROTECTED}/promotion`;
export const PROMOTION_DETAIL = (id: string | number) =>
  `${PROMOTION}/edit-campaign/${id}`;
...
export const SANCTION_DETAIL = (id: string | number) =>
  `${SANCTION}/edit-sanction/${id}`;
...
export const SOURCE_DETAIL = (id: string | number) =>
