 ...
 *
 * Usage:
 *   node apps/admin-portal/scripts/refactor/check-unsynced-updates.js [--apps app1,app2,...]
 *
 * Examples:
 *   node apps/admin-portal/scripts/refactor/check-unsynced-updates.js (checks all apps)
 *   node apps/admin-portal/scripts/refactor/check-unsynced-updates.js --apps admin-portal,ticket-portal
 */
...
node apps/admin-portal/scripts/refactor/check-unsynced-updates.js
...
`;
  ...
  md += '\n---\n\n';
  md +=
    '*This report was auto-generated by `apps/admin-portal/scripts/refactor/check-unsynced-updates.js`*\n';
