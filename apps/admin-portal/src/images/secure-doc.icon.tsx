...
const SecureDocIcon = (
  ...
  return (
    ...
    >
      <Box as="g" clipPath="url(#clip0_2921_562)">
        <Box
          as="path"
      ...
      <Box as="defs">
        <Box as="clipPath" id="clip0_2921_562">
          <Box
            as="rect"
            width={widthRect ? widthRect : defaultWidthRect}
            height={heightRect ? heightRect : defaultHeightRect}
            fill={colorRect ? colorRect : defaultColorRect}
