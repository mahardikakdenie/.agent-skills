          ...
          <Table style={styles.table} ref={reportTemplateRef}>
            <TableHeader>
              <TableRow>
                ...
                <TableHead style={styles.th}>Insured Name</TableHead>
                <TableHead style={styles.th}>Policy Number</TableHead>
                <TableHead style={styles.th}>Request Date</TableHead>
                <TableHead style={styles.th}>Approve Date</TableHead>
              ...
              {data.length > 0 ? (
                data.map((endorsement, index) => (
                  <TableRow key={endorsement.id}>
                    <TableCell style={styles.td}>{(page - 1) * rowsPerPage + index + 1}</TableCell>
                    <TableCell style={styles.td}>{endorsement.number}</TableCell>
                    ...
                    <TableCell style={styles.td}>{endorsement.policies?.number || '-'}</TableCell>
                    <TableCell style={styles.td}>
                    ...
                    <TableCell style={styles.td}>{endorsement.status}</TableCell>
                  </TableRow>
                ))
              ) : (
