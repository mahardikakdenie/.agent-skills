...
const EditIcon = (color?: string, width?: string, height?: string, viewBox?: string) => {
  return (
    ...
    >
      <Box as="g" clipPath="url(#clip0_5486_14634)">
        <Box
          as="path"
        ...
        <Box
          as="path"
          d="M15.0003 1.66602L18.3337 4.99935L10.0003 13.3327H6.66699V9.99935L15.0003 1.66602Z"
          stroke={color ? color : defaultColor}
          strokeWidth="2"
          strokeLinecap="round"
          strokeLinejoin="round"
      ...
      <Box as="defs">
        <Box as="clipPath" id="clip0_5486_14634">
          <Box as="rect" width="20" height="20" fill="white" />
        </Box>
      </Box>
    </Box>
  );
