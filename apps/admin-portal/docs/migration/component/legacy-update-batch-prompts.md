...
**Categorize each conflicted file using _migration-log.md:**

| Category | Indicator | Resolution |
|---|---|---|
| Migrated component | In _migration-log.md with Status=DONE; imports use @repo/ui | git checkout --ours <file> |
...
| Non-migrated component | Not in _migration-log.md; still uses local imports | git checkout --theirs <file> |
| In-progress batch item | In _migration-log.md with Status=IN PROGRESS | Manual merge - keep our base, apply legacy additions |
...
**Steps:**
1. Read <APP_PATH>/docs/migration/component/_migration-log.md to know which components are DONE
...
Per 06-component-standards.md Section 6.2:
...
- Create <APP_PATH>/docs/migration/component/legacy-updates/legacy-update-YYYYMMDD-HHMMSS.md with:
  ...
  * Current batch position (from _migration-plan.md)
...
- Check <APP_PATH>/docs/migration/component/_migration-log.md for batch status
...
Rules:
- Do NOT modify components classified as DONE in _migration-log.md
...
2. Document the API gap in <APP_PATH>/docs/migration/component/_spec-input.md:
   ### <ComponentName>
...
4. Add note in _migration-plan.md: "<ComponentName> - waiting for packages/ui Batch 3 extension"
5. Proceed to Batch 6

**For NEW_SHARED_COMPONENT:**
1. Document in <APP_PATH>/docs/migration/component/_spec-input.md:
   ### <ComponentName>
...
4. Add note in _migration-plan.md: "<ComponentName> - waiting for packages/ui Batch 4 build"
5. Proceed to Batch 6
...
- After Batch 6 cleanup is complete (_migration-log.md shows all items DONE)
...
- Verification gate: OK all passed
