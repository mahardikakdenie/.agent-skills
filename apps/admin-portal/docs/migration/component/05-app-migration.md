...
| `apps/<APP_NAME>/docs/migration/component/_output/_parity-checklist.md` | Updated status (from `[ ]` to `PASS` as items complete) |
...
> **Standard:** [06-component-standards.md Section 6.2](./06-component-standards.md#62-universal-soc-evaluation) - [06-component-standards.md Section 6.5](./06-component-standards.md#65-app-local-refactor-patterns) - [06-component-standards.md Section 6.6](./06-component-standards.md#66-re-classification-after-split)
...
See [06-component-standards.md Section 6.5](./06-component-standards.md#65-app-local-refactor-patterns) for full pattern code examples.
...
### Guardrails (same as Section 6.5 - non-negotiable)
...
## Parity Verification (per usage site - all must be PASS)
...
- All `_parity-checklist.md` items are PASS (or have a documented exception)
...
See [06-component-standards.md Section 6.5](./06-component-standards.md#65-app-local-refactor-patterns) for full patterns with code examples.
...
Then: manually verify the component's smoke route still renders identically. Capture before/after screenshots and add a comparison entry per `verification-gate.md Section 6`.
...
When a Shell passes the Section 6.5 "Good Shell Criteria" checklist (plain props only, no framework imports, no env vars, cross-app demand) -> classify it as a `NEW_SHARED_COMPONENT` candidate in `_migration-log.md` and queue it for Phase 04 (Build packages/ui).
