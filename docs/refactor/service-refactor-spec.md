...
Lifecycle diagram: `docs/refactor/service-refactor-lifecycle.md` (Mermaid).
...
- `docs/refactor/service-audit.md` (temporary)
- `docs/refactor/service-refactoring-plan.md` (temporary)
- `docs/refactor/verification-gate.md` (temporary)
...
2. Create `docs/refactor/service-audit.md` with **per-service sections**:
...
1. Create `docs/refactor/service-refactoring-plan.md` with:
...
Follow these steps:
1. First, audit all existing services and create docs/refactor/service-audit.md
2. Then create docs/refactor/service-refactoring-plan.md with the implementation blueprint
